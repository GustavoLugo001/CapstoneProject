...
# Load dataset
df = pd.read_csv("watering_data.csv")  # Ensure your CSV file is correct
...
joblib.dump(scaler, "watering_scaler.pkl")
...
model = Sequential([
    ...
    Dense(1, activation='linear')  # Predicts watering days
])
...
# Save trained model
model.save("water_schedule_model.h5")

print("✅ Model training complete and saved as 'water_schedule_model.h5'")
